    ...
    >
                ...
                <ul className="widget-list mt-3">
                  <li>
                    <div className="d-flex items-center">
                      ...
                      <span>
                        {" "}
                        Safe Food Headquarter,51/1, Senpara Parbata, Mirpur-10,
                        Dhaka
                      </span>
                    </div>
                  </li>
      ...
      <div className="footer-bottom font-weight-normal">
        <div className="container flex justify-evenly">
          ...
          <div>
            <dvi className="flex justify-center items-center">
              <Link
                href="https://www.facebook.com/safefoodsshop"
                style={{ height: "50px" }}
                target="_blank"
              >
                <BsFacebook className="text-4xl mx-4" />
              </Link>
              <Link
                href="https://www.youtube.com/@safefoodsshop"
                style={{ height: "50px" }}
                target="_blank"
              >
                <BsYoutube className="text-4xl mx-4" />
              </Link>
            </dvi>
          </div>
        </div>
